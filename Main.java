        ...
        while (pesanLagi) {
            ...
            if (tindakan == 1) {
                ...
                if (kapasitasRuangan > 100) {
                    double tambahanBiaya = 0.10; // pajak 10% jika kapasitas lebih dari 100t
                    double jumlahTambahanBiaya = totalHarga * tambahanBiaya;
                    totalHarga += jumlahTambahanBiaya;
                } else if (kapasitasRuangan > 50) {
                    double tambahanBiaya = 0.05; // pajak 5% jika kapasitas lebih dari 50
                    double jumlahTambahanBiaya = totalHarga * tambahanBiaya;
                    totalHarga += jumlahTambahanBiaya;
                }
